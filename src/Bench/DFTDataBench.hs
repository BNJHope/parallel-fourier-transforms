...
main = defaultMain [
        env setupEnv $ \ ~(samples256, samples512, samples1024) -> bgroup "DFT-Data" [
                bgroup "DFTData256" [
                    ...
                    bench "innerParMapReduce" $ nf dftInnerParMapReduce samples256
                ],
                bgroup "DFTData512" [
                    ...
                    bench "innerParMapReduce" $ nf dftInnerParMapReduce samples512
                ],
                bgroup "DFTData1024" [
                    ...
                    bench "innerParMapReduce" $ nf dftInnerParMapReduce samples1024
                ]
           ]
    ]
